            ...
            >
              ...
              >
                <Container maxWidth='xs' style={{ position: 'relative' }}>
                  <Avatar sx={{ m: 'auto', bgcolor: 'primary.main' }}><AccountCircleIcon /></Avatar>
                  <Box
                    sx={{
                      my: 8,
                      mx: 4,
                    ...
                    <Box component="form" border={'2px solid red'} onSubmit={handleSubmit(onSubmit)} noValidate sx={{ mt: 1 }}>
                      ...
                      <TextField
                        ...
                        label="Email Address"
                        name="email"
                        {...register('email', { required: 'Email is required', pattern: { value: /^\S+@\S+$/i, message: 'This mail is invaild' } })}
                      ...
                      <TextField
                        ...
                        label="Phone no"
                        name="phoneno"
                        {...register('phoneno', { required: 'Phone number is required', minLength: { value: 10, message: 'Please enter valid phone number' }, maxLength: { value: 10, message: 'Please enter valid phone number' } })}
                      ...
                      <Box style={{ textAlign: 'center' }} >
                        <Button
                          type="submit"
                          variant="contained"
                          sx={{ mt: 3, mb: 2 }}>Sign In</Button><br />
